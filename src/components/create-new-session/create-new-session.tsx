...
interface CreateNewSessionProps {
	...
	setDropdowns: React.Dispatch<React.SetStateAction<{ names: string[]; sessions: string[] }>>;
	dropdowns: { names: string[]; sessions: string[] };
}

export function CreateNewSession({ setData, dropdowns, setDropdowns }: CreateNewSessionProps) {
		...
		<>
			...
			<form onSubmit={handleSubmit} className="flex flex-col gap-4 border p-4 rounded-lg">
				...
				<div className="flex flex-col gap-2">
					...
					<Select value={form.yourName} onValueChange={(v) => setForm({ ...form, yourName: v })}>
				...
				<div className="flex flex-col gap-2">
					...
					<Select value={form.sessionConducted} onValueChange={(v) => setForm({ ...form, sessionConducted: v })}>
						<SelectTrigger>
