...
export function AllDataTable() {
	...
	const [dropdowns, setDropdowns] = useState({ names: [] as string[], sessions: [...sessions] });
	...
	return (
		<div className="space-y-10 mt-40">
			...
			{/* ---- New Session Form ---- */}
			<CreateNewSession setData={setData} dropdowns={dropdowns} setDropdowns={setDropdowns} />
			...
			{!loading && (
				<Pagination table={table} pageSize={pageSizeInput} setPageSize={setPageSizeInput} />
			)}
		</div>
	);
}
