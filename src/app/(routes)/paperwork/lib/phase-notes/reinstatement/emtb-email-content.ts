...
[b][i]Dear Mr./Ms [NAME]
[/i][/b]
Congratulations on passing your FTP certification and welcome to the EMT team! Below is a list of tools that every EMT uses eventually, please read through them!

As an EMT-B, you are eligible to join divisions now. You can see the currently available [url=https://gov.eclipse-rp.net/viewforum.php?f=1057]job listings here.[/url]
...
[list]Use the format located [url=https://gov.eclipse-rp.net/viewtopic.php?f=614&t=31818]here[/url].[*]Copy and paste the format into a new post, fill it out and say your goodbyes before heading out for the last time!
[/list]
