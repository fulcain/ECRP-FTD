...
import { EMTB_EMAIL_CONTENT } from "@/app/(routes)/paperwork/lib/phase-notes/reinstatement/emtb-email-content";
import { EMTI_EMAIL_CONTENT } from "@/app/(routes)/paperwork/lib/phase-notes/reinstatement/emti-email-content";
import { EMTA_EMAIL_CONTENT } from "@/app/(routes)/paperwork/lib/phase-notes/reinstatement/emta-email-content";
import { MASTER_EMT_EMAIL_CONTENT } from "@/app/(routes)/paperwork/lib/phase-notes/reinstatement/master-emt-email-content";
