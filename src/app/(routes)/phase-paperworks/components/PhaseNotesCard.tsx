...
import { resolveNormalNotes } from "@/app/(routes)/phase-paperworks/lib/phase-notes/registry";
...
/**
 * Read-only reference panel that mounts just below the phase selector on
 * the normal paperwork page. Picks the notes component for the active
 * phase from the registry and renders it; hidden when no phase is active
 * yet (e.g., on the very first render before SessionContext hydrates).
 */
