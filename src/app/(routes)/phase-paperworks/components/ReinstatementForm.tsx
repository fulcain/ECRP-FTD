...
import { generateReinstatementBBCode } from "@/app/(routes)/phase-paperworks/lib/generateReinstatementBBCode";
...
import {
  fetchEMRProfileLinks,
  EMRProfileLink,
} from "@/components/current-emrs/fetchCurrentEMRs";
            ...
            <CardContent>
              <div className="flex items-center gap-2 flex-wrap">
                <Select value={selectedEMR} onValueChange={setSelectedEMR}>
                  <SelectTrigger className="w-full md:w-64">
                    <SelectValue placeholder="Select Reinstatee" />
                  </SelectTrigger>
                  <SelectContent>
