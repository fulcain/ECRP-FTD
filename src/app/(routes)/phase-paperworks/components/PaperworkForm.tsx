            ...
            <Card className="border shadow-sm">
              ...
              <CardContent className="space-y-3">
                {/* Two checkbox rows wired as a single-select group — each
                    ...
                    generator (`generateBBCode`) keeps receiving the same
                    shape it always did. Clicking the currently-selected
                    checkbox clears the field (mirrors the dropdown's
                    unselectable "Select type" placeholder). Layout matches
                    the multi-checkbox Cards elsewhere in this form (see
                    "Phase-Specific Checkboxes") for visual consistency. */}
                <div className="flex items-center gap-2">
                  <Checkbox
