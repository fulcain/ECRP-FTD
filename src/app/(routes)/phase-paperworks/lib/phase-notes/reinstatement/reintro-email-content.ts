// Full Re-Introduction Email BBCode for the LSEMS Reinstatement
// paperwork flow, as hosted on the LSEMS reference pastebin
// (https://pastebin.com/raw/Dq7vYC7s). The "Copy Email" button in the
// Reinstatement Phase I phase notes writes this string verbatim to the
// trainer's clipboard so they can paste it directly into the in-game
// messaging system.
export const REINTRO_EMAIL_CONTENT = `[img]https://i.imgur.com/up3tIuh.png[/img]
...
[center]"[i]EMR [b]Lastname[/b] is requesting a field training officer to conduct [b]X[/b] reinstatement training session.[/i]"
[b][i](( Make sure to transmit this via text chat [c]/r[/c] ))[/i][/b][/center]
[color=transparent]spacer[/color]
[center][color=firebrick][b]Keep in mind that you cannot go on duty without a trainer![/b][/center][/color]
[/divbox]
