// Full Introduction Email BBCode as hosted on the LSEMS reference pastebin
...
[center]
"[i]EMR [b]Lastname[/b] is requesting a field training officer to conduct [b]X[/b] training session.[/i]"
